...
class Car(object):
    ...
    def __init__(self, make, model, mpg, tank_capacity):
        ...
        self.__mpg = float(mpg)
        self.__tank_capacity = float(tank_capacity)
    ...
    def get_total_range(self):
        return self.tank_capacity * self.mpg
...
class HybridCar(Car):  # 2 points
    ...
    def get_total_range(self):
        a = super().get_total_range()
        b = HybridCar.get_battery_range(self)
        return a + b
